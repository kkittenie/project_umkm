					...
					<div class="col-md-4 d-flex">
						<div class="intro d-lg-flex w-100 ftco-animate">
							...
							<div class="text">
								...
								<p>Our team is always here — to answer your questions, take your orders, and help you
									find
				...
				<div class="row">
					...
					<div class="col-md-6 wrap-about pl-md-5 ftco-animate py-5">
						<div class="heading-section">
							...
							<p>Taste is more than a sensation — it's a memory, a story, a journey. For over a century,
								we've
								brought people together through dishes that honor heritage and celebrate creativity.</p>
							<p>Our ingredients are handpicked, our techniques time-honored, and every plate is crafted
								with
								passion — from farm to flame to fork. Whether it’s your first visit or your hundredth,
								we
				...
				<div class="row">
					<div class="col-lg-2 col-md-4 ">
						<div class="sort w-100 text-center ftco-animate">
							<div class="img" style="background-image: url(images/kind1.jpg);"></div>
							<h3>Spicy</h3>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 ">
						<div class="sort w-100 text-center ftco-animate">
							<div class="img" style="background-image: url(images/kind2.jpg);"></div>
							<h3>Salty</h3>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 ">
						<div class="sort w-100 text-center ftco-animate">
							<div class="img" style="background-image: url(images/kind3.jpg);"></div>
							<h3>Sweet</h3>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 ">
						<div class="sort w-100 text-center ftco-animate">
							<div class="img" style="background-image: url(images/kind4.jpg);"></div>
							<h3>Refreshing</h3>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 ">
						<div class="sort w-100 text-center ftco-animate">
							<div class="img" style="background-image: url(images/kind5.jpg);"></div>
							<h3>Hot</h3>
						</div>
					</div>
					<div class="col-lg-2 col-md-4 ">
						<div class="sort w-100 text-center ftco-animate">
							<div class="img" style="background-image: url(images/kind6.jpg);"></div>
							<h3>Cold</h3>
						</div>
					</div>
